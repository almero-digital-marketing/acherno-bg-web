...
description: 'Казваме коренна промяна, защото подменихме всичко. За да сме сигурни, че няма да имаме проблеми на по-късен етап, сменихме ВиК и електро инсталациите, елиминирахме стари течове, изправихме стени, а където имаше нужда направихме нова замазка.'
...
rooms:
  -
    ...
    description: 'Само броени секунди са нужни, за да се потопите в една специална атмосфера, достойна да се конкурира с такава в модерен нюйоркски хол. Приглушена светлина, комбинирана с гланцови рафтове и декоративни камъни по стената.'
    pageLayout: 4
  ...
  -
    ...
    description: 'Една лека дизайнерска игра са и красивите сиви завеси, поставени по уникален и нестандартен начин, без да скриват красивата гледка която се открива от френските прозорци.'
    pageLayout: 2
  ...
  -
    ...
    description: 'Кухнята е елемента със съществено значение. Бяло и просторно, ретро с модерен привкус и не на последно място - удобно. Уредите са вградени. Мебелите са по поръчка. За всичко е предвидено място, така че да е прибрано и изчистено.'
    pageLayout: 1
  ...
  -
    ...
    description: 'Много гардероби и много, много, много обувки. Ако можеше и още гардероби за още обувки да сложим би било най -добре, но уви това беше максимума. Изстискахме от пространството всичко което успяхме.'
    pageLayout: 7
  ...
  -
    ...
    description: 'Не изневерихме на свежите светли тонове и в банята. За нея подбрахме бяла санитария, която да изпъкне на бежовите плочки. Обобсобихме и сравнително просторна душ кабина, която преградихме със стъклен параван.'
    pageLayout: 8
...
---
Всичко започна с една изрезка от вестник залепена на входната врата на стария и изцяло за ремонт апартамент. Статията имаше забавното заглавие „ Оптимизъм му е майката“, което остана и като мото, докато не махнаха входната врата. След това така и остана името на апартамента, още тогава решихме, че си се роди с името си, така да се каже. И като всяко нещо родено с име носи и съдбата си. Определено се направи с много оптимизъм и много енергия и мерак от страна на всички, но клиентката определено е един от най-позитивните, напористи и изпълнени с оптимизъм хора, които сме срещали.