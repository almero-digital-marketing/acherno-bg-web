...
description: 'Необикновен дизайн, съчетал в себе си младежката непринуденост и спокойствието на домашния уют. Интериор с вкус на шоколади. Млечни, натурални с пълнеж или с балончета. Шоколада е като дома. Всеки има различен вкус. Едни го харесват млечен, други го харесват черен. Някой го обичат и с лешници или бадеми.'
image: 'http://hub.acherno.com/svn/aero-shokolad/Site/Finalni/21.jpg'
rooms:
  -
    title: 'Вътрешен дизайн на (всекидневна)'
    description: 'По скоро е хол, кухня и трапезария в едно. Така позната ни комбинация. Съчетание между топло кафяво, мръсно бяло и почти прозрачно лилаво и лампите и столовете с характерна и допълваща се визия.'
  ...
  -
    ...
    description: 'Тук отново е позната ни комбинация от хола между бяло, дърво и лилаво. Уютно и приятно, даже може да поработиш и на компактното бюро.'
  ...
  -
    ...
    description: 'Леката линия в тавана те води и насочва. Лампите скрити в улея осветяват всичко толкова добре, че нямаш онова неприятно чувство, че газиш из сумрака.'
